...
\begin{figure}[H]
	...
	\caption{ Click to upload Image\label{f:Step1}}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{figs/Step2}
	\caption{ After Uploading Image, click on Process Image. The image will be segmented.\label{f:Step2}}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{figs/Step3}
	\caption{ Now click on Classify Image and it will classify the image.\label{f:Step3}}
\end{figure}
